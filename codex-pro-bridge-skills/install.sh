...
for name in "${managed[@]}"; do
  case "$name" in
    .shared|bundle-algorithm-context|experiment-plan-generator|gpt-pro-algorithm-pipeline|gpt-pro-paper-brainstormer|gpt-pro-project-workspace|gpt-pro-question-window|gpt-pro-research-algorithm-reviewer|gpt-pro-review-probe|implementation-consistency-checker) ;;
